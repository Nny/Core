...
{
    TB_GRAVTBARD_MAIN_ALLIANCE     = 1103,
    TB_GRAVTBARD_MAIN_HORDE        = 1104,
    TB_GRAVTBARD_BASE_4			   = 1105,
    TB_GRAVTBARD_BASE_3			   = 1106,
    TB_GRAVTBARD_BASE_2			   = 1107,
    TB_GRAVTBARD_BASE_1			   = 1108
};
